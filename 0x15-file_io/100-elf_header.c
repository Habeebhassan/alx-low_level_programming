...
/**
 * print_version - elf data printing
 * @h: header
 * Return: void
 */
...
int main(int argc, char **argv)
{
	...
	/* readine first 32 chars of header elf*/
	r_elf = read(fd_elf, h, 32);
	if (r_elf == -1)
		dprintf(STDERR_FILENO, "Error Reading File\n"), exit(98);
	/* check if if: magic number, ELF */
	_is_elf(h);
